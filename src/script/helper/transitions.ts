...
export function showSection(section: HTMLElement, visibleClass = "isVisible"): void {
    // make it "render"
...
export function hideSection( section: HTMLElement, durationMs = 600, visibleClass = "isVisible"): void {
